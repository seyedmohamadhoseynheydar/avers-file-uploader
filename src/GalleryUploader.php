...
class GalleryUploader extends Widget
{
    ...
    public function run()
    {
        ...
        if ($this->skin == 'bazar-rouz-iranian'){
             $html .= '<div onclick=\'openMultiUpload("' . $this->form_name . '")\' class="text-center col-md-4" style="background-color:#eaeaea;cursor:pointer; color: #18E3A4;margin-top: 10px;margin-bottom: 10px;border: 1px solid #18E3A4;border-radius: 10px;padding:1.8rem 0;display: table">';
